function Start-DPGroupContentDistribution {
    ...
    .SYNOPSIS
        ...
        The function can accept input object from Get-DPContent or Get-DPDistributionStatus, by manually specifying -ObjectID and -ObjectType or by using -Folder where it will distribute all objects for .pkgx files found in said folder.
