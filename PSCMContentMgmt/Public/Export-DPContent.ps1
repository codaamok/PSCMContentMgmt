function Export-DPContent {
    ...
    .DESCRIPTION
        ...
        Export-DPContent can be useful if you want to migrate the content library of one distribution point to another by also using Import-DPContent. If this is your intent, ensure you first configure your distribution point to allow prestage content (see Set-DPAllowPrestagedContent), distribute the content objects you want to import (see Start-DPContentDistribution) and then you should use Import-DPContent.
