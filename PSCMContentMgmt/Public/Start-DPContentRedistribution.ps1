function Start-DPContentRedistribution {
    <#
    .SYNOPSIS
        Initiates redistribution for objects to a given distribution point. The function can accept input object from Get-DPContent or Get-DPDistributionStatus.
